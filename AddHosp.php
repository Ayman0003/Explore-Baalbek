...
$result = mysqli_query($con , "INSERT INTO `Hospitals`(`Name`, `Hospitals`, `Email`, `Location`)  Values ('$_POST[fname]','$_POST[fhosp]','$_POST[femail]' ,'$_POST[flocation]')");
if(!$result)
       {
...
?>
          ...
          <section class="page-wrapper">
            ...
            <form action="" method="post" enctype="multipart/form-data" >
                ...
                <br>
                <button onclick="window.location.href='hospitals.html'"> Return </button>
              </form>
            </div>
